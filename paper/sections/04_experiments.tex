...
what the result implies in practice and a comparison with published results
on that dataset.
...
mean per-SP MAE (Table~\ref{tab:lit_all}: $0.0038$, against $0.0079$
...
vs.\ $0.0037$, $p<10^{-3}$ over ten repeats); at SP400 the two are
indistinguishable ($p=0.12$) and ours leads SP500 by $\sim$4$\times$
(MAE $0.0040$ vs.\ $0.0167$). Figure~\ref{fig:regen}
...
represent this pattern at all. \emph{In practice:} real
...
low-noise regime. The model leads on MAE at SP200 and SP300
(Table~\ref{tab:lit_all}: $0.0013$ vs.\ $0.0014$ and $0.0014$ vs.\
$0.0015$); at SP400 ModernTCN and RUL-Mamba are marginally ahead on
MAE ($0.0016$ vs.\ $0.0018$) while our R\textsuperscript{2} and AE are
better ($0.9996$ vs.\ $0.9995$ and $1.6$ vs.\ $2.7$--$2.9$).
