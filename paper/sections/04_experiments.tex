...
GOTION & 500 & 871 & 0.0077$\pm$0.0001 & 0.0103$\pm$0.0002 & 0.9967$\pm$0.0001 & 13.9 \\
  & 800 & 571 & 0.0087$\pm$0.0001 & 0.0117$\pm$0.0002 & 0.9928$\pm$0.0003 & 14.8 \\
  & 1100 & 271 & 0.0100$\pm$0.0002 & 0.0136$\pm$0.0003 & 0.9549$\pm$0.0019 & 14.1 \\
\midrule
...
PatchFormer & & \textbf{0.0061} & \textbf{0.0122} & \textbf{0.9919} & \textbf{0.2} & \textbf{0.0072} & \textbf{0.0137} & 0.9808 & 1.4 & \textbf{0.0072} & 0.0148 & 0.9623 & 2.5 \\
RUL-Mamba$^\dagger$ & & 0.0089 & 0.0142 & 0.9889 & 1.7 & 0.0090 & 0.0150 & 0.9771 & 1.3 & 0.0091 & 0.0158 & 0.9568 & 1.8 \\
Ours & & 0.0098 & 0.0145 & 0.9908 & 0.9 & 0.0089 & 0.0148 & \textbf{0.9822} & \textbf{0.4} & 0.0080 & \textbf{0.0115} & \textbf{0.9804} & \textbf{0.5} \\
\bottomrule
\multicolumn{14}{l}{\footnotesize PatchFormer and RUL-Mamba rows: self-run with the official repositories under the same per-SP protocol,}\\
...
model beats both reproduced baselines by 6--8$\times$ in MAE on
every SP (Table~\ref{tab:lit_gotion}: $0.0077$-$0.0100$ vs.\
$0.053$-$0.078$), while their R$^2$ stays competitive ($0.9962$ vs.
$0.9967$ at SP500) -- the gap concentrates in the capacity-scale
normalization, where operating a 27\,Ah range reacts badly to
per-window statistics. \emph{Operational implication:} large-format
assets are exactly where on-device monitoring pays for itself in
maintenance optics; the surplus accuracy here translates into
replacement planning with margin.

\begin{table}[htbp]
\centering
\caption{GOTION (SP 500/800/1100): comparison with reproduced
baselines. Bold marks the best value in each column; ties are both
bold. Ours: 10-seed means; baselines: 10 repeats each.}
...
Method & & \multicolumn{4}{c}{SP500} & \multicolumn{4}{c}{SP800} & \multicolumn{4}{c}{SP1100} \\
 & & MAE & RMSE & R$^2$ & AE & MAE & RMSE & R$^2$ & AE & MAE & RMSE & R$^2$ & AE \\
\midrule
PatchFormer & & 0.0537 & 0.0706 & 0.9962 & \textbf{9.3} & 0.0631 & 0.0822 & 0.9912 & \textbf{7.0} & 0.0776 & 0.1025 & 0.9385 & \textbf{4.6} \\
RUL-Mamba & & 0.0529 & 0.0754 & 0.9956 & 15.8 & 0.0614 & 0.0875 & 0.9901 & 16.5 & 0.0718 & 0.1040 & 0.9368 & 15.7 \\
Ours & & \textbf{0.0077} & \textbf{0.0103} & \textbf{0.9967} & 13.9 & \textbf{0.0087} & \textbf{0.0117} & \textbf{0.9928} & 14.8 & \textbf{0.0100} & \textbf{0.0136} & \textbf{0.9549} & 14.1 \\
\bottomrule
\multicolumn{14}{l}{\footnotesize All rows self-run under the same per-SP protocol (Ours: 10 seeds; baselines: 10 repeats with their}\\
\multicolumn{14}{l}{\footnotesize official code). GOTION has no prior published SOH comparison, so this is, to our knowledge, the}\\
\multicolumn{14}{l}{\footnotesize first centralized large-format baseline evaluation.}\\
\end{tabular}%
}
\end{table}
