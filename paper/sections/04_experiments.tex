...
\midrule
\multirow{3}{*}{\shortstack[l]{MIT\\\emph{200/300/400}}} & PatchFormer & \textbf{0.0008} & 0.9997 & \textbf{0.6} & \textbf{0.0008} & 0.9997 & \textbf{0.8} & \textbf{0.0009} & 0.9995 & \textbf{0.4} \\
  & RUL-Mamba & 0.0011 & 0.9994 & 1.4 & 0.0016 & 0.9991 & 1.1 & 0.0022 & 0.9979 & 1.0 \\
  & Ours & 0.0019 & \textbf{0.9998} & 0.9 & 0.0025 & \textbf{0.9997} & 0.9 & 0.0032 & \textbf{0.9995} & 1.1 \\
\midrule
...
(Table~\ref{tab:lit_all}) the model ranks first on
R\textsuperscript{2} at all three starting points, third on MAE, and
within one cycle of the best AE. Per-SP protocol (every (SP, seed) retrained from scratch, 10 seeds
...
isolates the cross-scale mechanism but does not establish it on a
second dataset; the physics extension is also ten-seed, and the
