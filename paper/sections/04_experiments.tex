...
open. Both the single-branch encoder and the full multi-scale model are
implemented in C and verified on emulated hardware; the deployed
footprints, the cross-architecture agreement and the caveats that come
with emulation are given in Section~\ref{sec:deploy}.
