...
2.5\,Ah), and GOTION (large-format, 27\,Ah). End-of-life (EOL) thresholds follow rated
...
GOTION & large-format & 27 Ah & 3 & 21.60 & large-format fleet \\
\bottomrule
\end{tabular}}
\end{table}
...
($0.9804$ vs.\ $0.9623$) and at SP70 ($0.9822$ vs.\ $0.9808$), while
its MAE remains slightly ahead ($0.0080$ vs.\ $0.0072$ at SP90;
AE $0.5$ vs.\ $2.5$).
...
GOTION (27\,Ah, three cells, 2 train / 1 test) is the large-format
regime: 1400-cycle deep-discharge profiles with a wide dynamic
range, the format of grid-storage and heavy-duty applications. Our
...
\begin{tabular}{ll rrrr rrrr rrrr}
\toprule
Method & & \multicolumn{4}{c}{SP500} & \multicolumn{4}{c}{SP800} & \multicolumn{4}{c}{SP1100} \\
 & & MAE & RMSE & R$^2$ & AE & MAE & RMSE & R$^2$ & AE & MAE & RMSE & R$^2$ & AE \\
\midrule
...
\bottomrule
\multicolumn{14}{l}{\footnotesize ModernTCN--PathFormer rows as reported in OmniTIEFormer's GOTION experiments (same test cell, SPs, EOL);}\\
\multicolumn{14}{l}{\footnotesize PatchFormer and RUL-Mamba rows self-run with the official repositories (10 repeats; the RUL-Mamba AE is}\\
...
and their associated variance is not quantified. \emph{Epoch
