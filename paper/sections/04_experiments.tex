...
general time-series transformers. On NASA and TJU the
...
CY25-1 are used identically by all works). On CALCE and
PANASONIC---where RUL-Mamba's own paper has no results---we use
OmniTIEFormer's baseline runs of RUL-Mamba \cite{ref_omnitie},
which also report AE.
