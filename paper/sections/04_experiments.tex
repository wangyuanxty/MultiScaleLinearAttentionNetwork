...
\midrule
\multicolumn{7}{l}{\emph{Average across all SPs and seeds: AE = 3.7 cycles, R\textsuperscript{2} = 0.9948, MAE = 0.0053.}} \\
\bottomrule
\end{tabular}
\end{table}
...
$0.0065$--$0.0085$ vs.\ $0.0057$--$0.0081$; R\textsuperscript{2} within $0.004$; AE
...
Method & & \multicolumn{4}{c}{SP300} & \multicolumn{4}{c}{SP400} & \multicolumn{4}{c}{SP500} \\
 & & MAE & RMSE & R\textsuperscript{2} & AE & MAE & RMSE & R\textsuperscript{2} & AE & MAE & RMSE & R\textsuperscript{2} & AE \\
\midrule
...
\multicolumn{14}{l}{\footnotesize 10 repeats per SP (seeds 1--10); PatchFormer reproduces its published CALCE values (MAE/R\textsuperscript{2} $0.0057/0.9962$}\\
...
AE $=$ 2.9 (R\textsuperscript{2} $0.9962$ vs.\ $0.9950$).
...
(Table~\ref{tab:lit_nasa}); on R\textsuperscript{2} we exceed the self-run
...
\bottomrule
\multicolumn{14}{l}{\footnotesize PatchFormer and RUL-Mamba rows: self-run with the official repositories under the same per-SP protocol,}\\
\multicolumn{14}{l}{\footnotesize 10 repeats per SP (seeds 1--10; PatchFormer batch size 16, its NASA tuning); their published values were MAE/R\textsuperscript{2}}\\
...
MAE $0.0037$ vs.\ $0.0105$ for the strongest baseline at SP300; R\textsuperscript{2}
...
SP200, R\textsuperscript{2} $0.9999$ vs.\ $0.9998$, AE $0.2$ vs.\ $2.1$; at SP400
R\textsuperscript{2} $0.9996$ vs.\ $0.9994$ and AE $1.6$ vs.\ $3.0$).
...
\bottomrule
\multicolumn{14}{l}{\footnotesize PatchFormer and RUL-Mamba rows: self-run with the official repositories under the same per-SP protocol,}\\
\multicolumn{14}{l}{\footnotesize 10 repeats per SP (seeds 1--10); published values were MAE/R\textsuperscript{2} $0.0013/0.9999$, $0.0014/0.9997$, $0.0015/0.9996$}\\
\multicolumn{14}{l}{\footnotesize (PatchFormer) and $0.0014/0.9998$, $0.0015/0.9997$, $0.0016/0.9995$ (RUL-Mamba).}\\
\multicolumn{14}{l}{\footnotesize $^{\ddagger}$RUL-Mamba self-run is univariate and reproduces the published TJU numbers (R\textsuperscript{2} $0.9998/0.9997/0.9995$),}\\
...
vs.\ $0.053$-$0.061$), and also leads their R\textsuperscript{2} ($0.9970$ vs.
...
\begin{table}[htbp]
\centering
\caption{Architecture ablation, ten seeds, full-sequence MAE / R\textsuperscript{2} /
...
\begin{tabular}{lcccc}
\toprule
Dataset & Configuration & MAE & R\textsuperscript{2} & AE \\
\midrule
...
\begin{tabular}{lcc}
\toprule
Predictor & Tail R\textsuperscript{2} & Tail MAE (norm.) \\
\midrule
