...
\begin{table}[htbp]
\centering
\caption{Comparison with reference baselines on all five
published-comparison datasets. MAE in normalized capacity; each
dataset's starting points are given in its heading; bold marks the
...
\toprule
Method & & \multicolumn{3}{c}{SP1} & \multicolumn{3}{c}{SP2} & \multicolumn{3}{c}{SP3} \\
\midrule
  \multicolumn{11}{l}{\emph{PANASONIC} (SP 300/400/500)} \\
  \midrule
  PatchFormer & & \textbf{0.0033} & \textbf{0.9977} & 1.0 & 0.0037 & \textbf{0.9965} & 1.0 & 0.0167 & 0.9698 & 3.6 \\
  ...
  Ours & & 0.0037 & 0.9976 & \textbf{0.8} & \textbf{0.0036} & \textbf{0.9965} & \textbf{0.8} & \textbf{0.0040} & \textbf{0.9936} & \textbf{0.9} \\
\midrule
\midrule
  \multicolumn{11}{l}{\emph{TJU} (SP 200/300/400)} \\
  \midrule
  TimeMixer & & 0.0071 & 0.9963 & 7.6 & 0.0086 & 0.9919 & 6.0 & 0.0123 & 0.9777 & 6.5 \\
  ...
  ModernTCN & & 0.0014 & 0.9998 & 2.8 & 0.0015 & 0.9997 & 2.7 & \textbf{0.0016} & 0.9995 & 2.7 \\
  ...
  RUL-Mamba$^{\ddagger}$ & & 0.0014 & 0.9998 & 2.8 & 0.0015 & 0.9997 & 2.9 & \textbf{0.0016} & 0.9995 & 2.9 \\
  Ours & & \textbf{0.0013} & \textbf{0.9999} & \textbf{0.2} & \textbf{0.0014} & \textbf{0.9998} & 0.9 & 0.0018 & \textbf{0.9996} & 1.6 \\
\midrule
\midrule
  \multicolumn{11}{l}{\emph{GOTION} (SP 450/600/750)} \\
  \midrule
  ModernTCN & & 0.0553 & 0.9960 & \textbf{8.3} & 0.0570 & 0.9947 & \textbf{8.0} & 0.0619 & 0.9921 & \textbf{7.8} \\
  ...
  Ours & & \textbf{0.0074} & \textbf{0.9970} & 18.2 & \textbf{0.0081} & \textbf{0.9958} & 10.7 & \textbf{0.0086} & \textbf{0.9938} & 15.1 \\
\midrule
  \multicolumn{11}{l}{\emph{NASA} (SP 50/70/90)} \\
  \midrule
  TimeMixer & & 0.0239 & 0.9540 & 8.0 & 0.0241 & 0.9014 & 6.7 & 0.0203 & 0.8290 & 9.0 \\
  ...
  PatchFormer & & \textbf{0.0061} & \textbf{0.9919} & \textbf{0.2} & \textbf{0.0072} & 0.9808 & 1.4 & \textbf{0.0072} & 0.9623 & 2.5 \\
  RUL-Mamba$^\dagger$ & & 0.0089 & 0.9889 & 1.7 & 0.0090 & 0.9771 & 1.3 & 0.0091 & 0.9568 & 1.8 \\
  Ours & & 0.0098 & 0.9908 & 0.9 & 0.0089 & \textbf{0.9822} & \textbf{0.4} & 0.0080 & \textbf{0.9804} & \textbf{0.5} \\
\midrule
\midrule
  \multicolumn{11}{l}{\emph{CALCE} (SP 300/400/500)} \\
  \midrule
  TimeMixer & & 0.0244 & 0.9608 & 15.8 & 0.0287 & 0.9512 & 16.4 & 0.0341 & 0.9245 & 16.7 \\
  ...
  RUL-Mamba$^{\mathsection}$ & & 0.0175 & 0.9782 & 11.5 & 0.0201 & 0.9733 & 13.1 & 0.0245 & 0.9605 & 15.7 \\
  PatchFormer & & \textbf{0.0057} & \textbf{0.9962} & \textbf{0.9} & \textbf{0.0068} & \textbf{0.9951} & \textbf{0.9} & \textbf{0.0081} & \textbf{0.9930} & \textbf{1.0} \\
  Ours & & 0.0066 & 0.9951 & 3.2 & 0.0078 & 0.9933 & 2.5 & 0.0092 & 0.9898 & 2.4 \\
\midrule
\bottomrule
\end{tabular}
\end{table}
...
and every SP against all published baselines (Table~\ref{tab:lit_all}:
...
every SP (Table~\ref{tab:lit_all}: MAE $0.0013$ vs.\ $0.0014$ at
...
in MAE on each SP (Table~\ref{tab:lit_all}: $0.0074$-$0.0086$
