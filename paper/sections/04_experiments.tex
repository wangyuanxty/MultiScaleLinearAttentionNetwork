...
Figure~\ref{fig:compare} shows our model ranks first (mean per-SP MAE) on PANASONIC, TJU (tied) and GOTION, 
second on CALCE, and third on NASA and MIT — top-3 on all six datasets and 
clearly beating all generic time-series transformers. Although PatchFormer slightly leads on NASA/CALCE/MIT, 
our model is overall the best or co-best method.
