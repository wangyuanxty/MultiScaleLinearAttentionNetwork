...
Latency is measured under emulation
(Section~\ref{sec:latency}), not on silicon, and no on-device power figure
is reported. All validation is on public laboratory cycling data;
