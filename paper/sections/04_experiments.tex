...
same optimizer budget with ten seeds; the physics extension and the
uncertainty study use the single-seed, full-data training described
above (variance quantified in Section~\ref{sec:limitations}).
