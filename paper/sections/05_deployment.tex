...
matrix is $16$\,KB --- smaller than our state; the crossover is
near $L\approx55$ tokens. When the sequence length $L{=}1024$ , the score matrix alone consumes 
$16$\,MB, which is equivalent to $341$ the state size of our proposed scheme. The argument is therefore not a
linear-attention model is cheaper today, but its cost does not move
