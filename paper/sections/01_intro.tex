...
verified bit-identical across x86 and ARM emulation. Because the state
...
prerequisite for per-device monitoring at fleet scale and near-zero
marginal cost.
...
INT8-quantized model whose fixed 8\,KB recurrent state does not grow
