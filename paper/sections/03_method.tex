...
channel-wise gate---erase on the key axis, write on the value axis---and
it recovers Gated DeltaNet exactly when both gates and the decay
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{figures/fig_gdn2_flow}
...
trained in absolute space reaches MAE $0.0090\pm0.0058$ (worse than
the z-score free head at $0.0065\pm0.0003$), while the rate head
reaches $0.00427\pm0.00002$. The extension
