...
DATASETS = {
    "nasa": dict(
        ...
        eol_frac=0.7, out_dir="results_RUL_ABS_prediction_sl_30",
    ...
    "calce": dict(
        ...
        eol_frac=0.7, out_dir="results_CALCE_ABS_prediction_sl_64",
        json_out="results/pf_calce_ABS_selfrun_CS2_35.json",
...
def main():
    ...
    for sp in cfg["sps"]:
        ...
        while count < args.count:
            count += 1
            seed = count
            if False and any(r.get("seed") == seed for r in per_run):  # ABS_TARGET run: train fresh
